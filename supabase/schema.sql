...
CREATE TABLE public.analytics_logs (
  ...
  language character varying CHECK (language::text = ANY (ARRAY['vi'::character varying::text, 'en'::character varying::text, 'zh'::character varying::text, 'es'::character varying::text, 'hi'::character varying::text, 'ar'::character varying::text, 'ja'::character varying::text, 'fr'::character varying::text, 'ko'::character varying::text, 'pt'::character varying::text, 'de'::character varying::text, 'ru'::character varying::text, 'id'::character varying::text, 'bn'::character varying::text, 'ur'::character varying::text, 'te'::character varying::text, 'mr'::character varying::text, 'tr'::character varying::text])),
